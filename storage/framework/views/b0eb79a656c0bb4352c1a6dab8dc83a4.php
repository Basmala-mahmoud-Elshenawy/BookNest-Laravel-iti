...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BookNest — Find Your Next Great Book'); ?></title>
...
<body>
    ...
    <main>
        <?php if($errors->any()): ?>
            <div class="container" style="margin-top:20px;"><div class="card card-pad form-error"><ul style="margin:0;padding-left:18px;"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($error); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul></div></div>
        <?php endif; ?>

        <?php if(session('status')): ?>
            <div class="container" style="margin-top:20px;">
                <div class="card card-pad" style="border-left:4px solid var(--color-button);"><?php echo e(session('status')); ?></div>
            </div>
        <?php endif; ?>
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <section class="floating-chat-panel card" id="floating-chat-panel" hidden aria-label="BookNest AI Assistant">
            ...
            <div class="floating-chat-messages" id="floating-chat-messages">
                <div class="chat-bubble bot">Hi <?php echo e(auth()->user()->name); ?>! What would you like to know?</div>
            </div>
    ...
    (() => {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            try {
                const response = await fetch('<?php echo e(route('chatbot.send')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\Users\BASMALA\Downloads\BookNest-Final-Fixed-v2\booknest\resources\views/layouts/app.blade.php ENDPATH**/ ?>